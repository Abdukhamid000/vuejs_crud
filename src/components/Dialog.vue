<template>
  <div aria-hidden="true"
       class="overflow-y-auto overflow-x-hidden bg-[#00000099] fixed top-0 flex right-0 left-0 z-50 justify-center items-center w-full md:inset-0   max-h-full"
       tabindex="-1">
          ...
          <slot name="footer">
            <button
              ...
              <svg v-if="loading" aria-hidden="true"
                   class="w-6 h-6 text-gray-200 animate-spin :text-gray-600 fill-green-600" fill="none"
